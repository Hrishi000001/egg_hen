...
class Board extends JPanel {
    ...
    private void BindEvents() {
        ...
        public static void playHenSound() {
            try {
                // Load the sound file
                AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("C:\\Users\\Hrishikesh\\eclipse-workspace\\game.dev\\src\\game\\dev\\chicken-noise-196746.wav"));
    ...
    public void paintComponent(Graphics pen) {
        ...
        pen.drawString("_________________________________________________________________________________________________________",0, 173);
    }
}
